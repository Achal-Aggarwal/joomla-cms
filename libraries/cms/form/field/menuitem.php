...
class JFormFieldMenuitem extends JFormFieldGroupedList
{
	...
	public function setup(SimpleXMLElement $element, $value, $group = null)
	{
		...
		if ($result == true)
		{
			...
			$this->published = $element['published'] ? explode(',', (string) $element['published']) : array();
			$this->disable = $element['disable'] ? explode(',', (string) $element['disable']) : array();
			$this->language = $element['language'] ? explode(',', (string) $element['language']) : array();
		}
